...
// The configured address is the reviewed V1 Coston2 deployment. Keep V2 writes
// disabled until a reviewed openMandateAndCharge deployment replaces it.
export const V2_CHECKOUT_DEPLOYED = false
