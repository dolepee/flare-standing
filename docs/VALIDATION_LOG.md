...
- Current live state (queried 2026-07-21):
  ...
  - mandate 1 is canceled with deposited and remaining balances both zero after refund
...
- The technical 48-hour Coston2 lifecycle gate is complete. External user validation remains separate and must not be inferred from this controlled signer run.

### Immediate next action

- Recruit and document the first external subscriber and merchant path without changing the validated contract core.
